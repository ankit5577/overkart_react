      ...
      <div className="text-center">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            ...
            Get latest deals on 200+ Products
          </h2>
          <p className="text-base text-gray-700 md:text-lg">
            We Have Over 100 brands with 400+ Products ready to be yours.
          </p>
        </div>
        ...
        <p className="max-w-md mx-auto mb-10 text-xs text-gray-600 sm:text-sm md:mb-16">
          Subsrible to our NewLetter to get latest updates on Discount or
          festival Offers.
        </p>
        <button
          onClick={() => {
