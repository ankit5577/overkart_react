...
function Topbar() {
  return (
    <div className="bg-gray-100 text-gray-600 px-4 hidden md:flex">
      <div className="container mx-auto flex justify-around">
        <div className="flex flex-row">
            <div className="self-center">
                <img className="w-4 mr-1" src="https://img.icons8.com/material-outlined/24/000000/phone.png" alt="phone"/>
            </div>
